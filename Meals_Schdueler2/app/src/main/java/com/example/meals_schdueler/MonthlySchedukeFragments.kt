...
class MonthlySchedukeFragments : Fragment() {
    ...
    internal inner class myAdapter (fm: FragmentManager) : FragmentPagerAdapter(fm){
        ...
        override fun getItem(position: Int): Fragment {
            when(position){
                0-> return AddMonthlyScheduleFragment()
                1-> return MyMonthlyScheudleFragment()
        ...
        override fun getPageTitle(position: Int): CharSequence? {
            when(position){
                0-> return "Add Monthly Schedule"
                1-> return "My Monthly Schedule"
